...
const DonorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchDonations = async () => {
      try {
        const data = await apiFetch<{ donations: Donation[] }>(
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-surface rounded-xl shadow-serene border border-border">
        <h2 className="text-xl font-bold font-display text-text-primary p-4 border-b border-border">
          Donation History
        </h2>
          ...
          {isLoading ? (
            ...
            <div className="p-10 text-center text-text-secondary">
              <ion-icon
                ...
                className="text-5xl mx-auto text-gray-300"
              ></ion-icon>
