    ...
    >
      ...
      <div className="p-6 flex-grow flex flex-col">
        <div className="flex items-center mb-2">
          ...
          />
          <span className="text-sm font-medium text-color-text-secondary dark:text-gray-400">
            {campaign.organizer}
          </span>
          {campaign.verified && (
            <FiCheckCircle
        ...
        <p className="text-color-text-primary dark:text-gray-300 text-sm mb-4 line-clamp-2">
        ...
        <div className="mt-auto">
          ...
          <div className="flex justify-between text-sm font-semibold text-color-text-headings dark:text-gray-100 mt-2">
            <span>
              ...
              <span className="font-normal text-color-text-secondary dark:text-gray-400">
                raised
              </span>
            </span>
          ...
          <Link
            ...
            className="mt-4 w-full text-center inline-block bg-brand-gold text-color-text-on-accent font-bold py-2 px-4 rounded-md hover:bg-brand-gold/90 transition-colors"
          >
            Donate Now
          </Link>
        </div>
