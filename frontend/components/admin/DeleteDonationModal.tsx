...
const DeleteDonationModal: React.FC<DeleteDonationModalProps> = ({ isOpen, onClose, onConfirm, donation }) => {
                ...
                >
                    ...
                    >
                        <div className="p-6 text-center">
                            ...
                            <h3 className="mt-5 text-lg font-medium leading-6 text-gray-900 dark:text-white">Delete Donation Record</h3>
                            <div className="mt-2 px-7 py-3">
                                <p className="text-sm text-gray-500 dark:text-gray-400">
                                    Are you sure you want to permanently delete the donation of <strong className="text-gray-800 dark:text-gray-200">₹{donation.amount.toLocaleString()}</strong> by <strong className="text-gray-800 dark:text-gray-200">{donation.donorId.fullName}</strong>? This action cannot be undone.
                                </p>
                            </div>
                        </div>
